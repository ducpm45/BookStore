...
values ('<p style="text-align: justify"><span style="font-size: 14px">
       Nếu bạn có thể dành hàng giờ trong các hiệu sách nhỏ, thích một cuốn sách hay, yêu mùi sách và thường tìm đến thư viện để thư giãn, thì <strong>Một thư viện ở Paris</strong> là cuốn sách dành cho bạn.
     </span></p>
<p style="text-align: justify">
    <span style="font-size: 14px">
      Dựa trên câu chuyện có thật trong Thế chiến thứ Hai về những thủ thư anh hùng của Thư viện Hoa Kỳ ở Paris, "<strong>Một thư viện ở Paris</strong>" của Janet Skeslien Charles kể về một câu chuyện khó quên về tình yêu đầy lãng mạn,
  ...
  cũng như gửi đi các tài liệu đọc bị cấm thay vì tiêu hủy chúng.</span></p>
<p style="text-align: justify">
    <span style="font-size: 14px">
  ...
  ở lại Paris yêu quý của mình. Cô kết hôn với một người lính Mỹ và chuyển đến Montana, nơi cô sống nhiều năm trong cô đơn như một người ngoài cuộc.</span></p>
  <p style="text-align: justify">
    <span style="font-size: 14px">
  ...
  một tình bạn bền chặt sẽ được hun đúc. Cùng nhau, Odile và Lily từ từ đối mặt với hậu quả của những lựa chọn trong quá khứ và hiện tại.</span></p>
<p style="text-align: justify">
    <span style="font-size: 14px">
  ...
  những gì cô bé đã học được trong lớp lịch sử. Với tư cách là độc giả, chúng ta nhìn cuộc chiến bằng lăng kính của hiện tại và tương lai – lịch sử sống lại và sau đó được làm sáng tỏ từ nhiều thập kỉ trong tương lai.</span></p>
<p style="text-align: justify">
    <span style="font-size: 14px">
  ...
  cuốn tiểu thuyết giúp chúng ta thấy rằng mọi thứ thường không giống như những gì chúng có vẻ là. Và, đó là một sự pha trộn tuyệt đẹp giữa thực tế và hư cấu.</span></p>
<p style="text-align: justify">
    <span style="font-size: 14px">
  ...
  có những hi sinh phi thường, nhưng câu chuyện về những người thủ thư này và những người bảo trợ của họ (dựa trên những con người và tình huống có thật) là hoàn toàn độc đáo và đáng kinh ngạc.
        ...
        'Janet Skeslien Charles', 0, 1, '/img/mot-thu-vien-o-paris.jpg', 'Tiếng Việt',
    ...
    <span style="font-size: 14px">
      Đoàn kết như sói, tạo dựng tập thể trên dưới một lòng,
        ...
        'Phạm Nhung', 0, 2, '/img/tri-tue-loai-soi-tb-2022.jpg', 'Tiếng Việt',
...
Với vô số những thông tin thú vị và hình ảnh tuyệt đẹp, bách khoa toàn thư khoa học đã khiến cho vật lý, hóa học,
        ...
        'Nhiều tác giả', 0, 3, '/img/bach-khoa-toan-thu-khoa-hoc.jpg', 'Tiếng Việt',
  ...
  “Nói chuyện thông thường mà như phỏng vấn vậy!”, “Sao để lấp đầy khoảng lặng kì cục này?” khiến bạn mệt mỏi không còn sức lực.
    ...
    <p style="text-align: justify">
      ...
      sự im lặng không tạo nên bầu không khí dễ chịu, các mối quan hệ không thể tiếp tục vì đơn giản là… không còn hứng thú để trò chuyện nữa.
      Vậy đâu là mấu chốt khiến việc giao tiếp của bạn đi vào “ngõ cụt”? Làm thế nào để “cấp cứu” những câu chuyện nhàm chán?
      Làm sao để người khác luôn thích được chia sẻ với bạn?
        </span></p>
 <p style="text-align: justify">
     <span style="font-size: 14px">
...
',
        'Tatsunari Iota', 0, 4, '/img/giao-tiep-co-ban.jpg', 'Tiếng Việt',
...
',
        'Anthony William', 0, 5, '/img/co-the-tu-chua-lanh-giai-cuu-gan.jpg', 'Tiếng Việt',
 ...
 <p style="text-align: justify">
   ...
   Với những trang sách này, chúng ta mới cảm nhận được những nét phác thảo chặng đường cầm quân của Tổng tư lệnh Võ Nguyên Giáp trong suốt cuộc trường chinh đánh thắng hai đế quốc lớn.</span></p>',
        'Trần Trọng Trung', 0, 6, '/img/vo-nguyen-giap-danh-tuong-thoi-dai-hcm.jpg', 'Tiếng Việt',
 ...
 <p style="text-align: justify"><span style="font-size: 14px">
   ...
   giúp bạn đọc hiểu rõ hơn nguyên tác. Cuốn sách còn có phần phụ như giải thích, dịch nghĩa bằng câu từ tinh tế giúp bạn đọc thưởng thức trọn vẹn nội dung tác phẩm.</span></p>',
        'Tư Mã Thiên', 0, 7, '/img/su-ky-tu-ma-thien.jpg', 'Tiếng Việt', 'Sử Ký Tư Mã Thiên (Bìa Cứng)',
...
',
        'Đinh Quang Hải', 0, 8,
        '/img/quan-he-bien-gioi-tren-dat-lien-giua-trung-quoc-va-cac-quoc-gia-lang-gieng.jpg', 'Tiếng Việt',
...
',
        'Gary Goldschneider', 0, 9, '/img/chiem-tinh-hoc-ung-dung.jpg', 'Tiếng Việt',
 ...
 <p style="text-align: justify">
   ...
   Online flashcard hỗ trợ học sinh ghi nhớ từ một cách dễ dàng và có hệ thống.
        ...
        'Vicky Liu', 0, 10, '/img/ielts-trung-hoc-pre-intermediate-book-2.jpg', 'Tiếng Việt',
