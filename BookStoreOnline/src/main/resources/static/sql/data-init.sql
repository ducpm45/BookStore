...
insert into tbl_books (book_about, book_author, book_discount, book_image, book_language, book_name,
                       book_price, book_publish_date, book_publisher, book_quantity, book_category_id)
values ('Nếu bạn có thể dành hàng giờ trong các hiệu sách nhỏ, thích một cuốn sách hay, yêu mùi sách và thường tìm đến thư viện để thư giãn, thì Một thư viện ở Paris là cuốn sách dành cho bạn.
...
Tạp chí Kirkus đánh giá đây là “Một cuốn tiểu thuyết dành riêng cho những ai yêu sách và thư viện.” Một thư viện ở Paris nhắc nhở chúng ta về những điều khủng khiếp trong quá khứ, và tất cả những gì mà chúng ta phải biết ơn cho đến bây giờ. Hi vọng rằng tất cả những người yêu sách tìm thấy niềm an ủi trong câu chuyện này.', 'Janet Skeslien Charles', 0.1, '/img/mot-thu-vien-o-paris.jpg', 'Tiếng Việt', 'Một thư viện ở Paris', 250000, '2022-06-12', 'NXB Văn Học', 100, 1 ),
    ...
    </span></p>', 'Phạm Nhung', 0, '/img/tri-tue-loai-soi-tb-2022.jpg', 'Tiếng Việt', 'Trí Tuệ Loài Sói - Doanh Nghiệp Tạo Dựng Tập Thể Xuất Sắc Như Thế Nào? (Tái bản năm 2022)', 150000, '2022-06-17', 'NXB Dân Trí', 100, 2 ),
       ('<p style="text-align: justify">
    <span style="font-size: 14px">
...
Với vô số những thông tin thú vị và hình ảnh tuyệt đẹp, bách khoa toàn thư khoa học đã khiến cho vật lý, hóa học,
    ...
    </span></p>', 'Nhiều tác giả', 0, '/img/bach-khoa-toan-thu-khoa-hoc.jpg', 'Tiếng Việt', 'Sách - Bách khoa toàn thư khoa học', 430000, '2022-07-18', 'Công ty CP Đầu tư và Phát triển giáo dục quốc tế Á Châu', 100, 3 ),
       ('<p style="text-align: justify">
    <span style="font-size: 14px">
 ...
 <p style="text-align: justify">
   ...
   trò chuyện hay kết nối cũng có gì khó khăn lắm đâu nhỉ?”
     </span></p>', 'Tatsunari Iota', 0, '/img/giao-tiep-co-ban.jpg', 'Tiếng Việt', 'Giao Tiếp Cơ Bản - Cẩm Nang Làm Chủ Mọi Cuộc Trò Chuyện', 129000, '2022-08-15', 'NXB Thế Giới', 100, 4 ),
       ('<p style="text-align: justify">
    <span style="font-size: 14px">
 ...
 <p style="text-align: justify">
   ...
   cân bằng đường huyết, hạ huyết áp, giảm cân, và trông tươi trẻ hơn.
     ...
     <p style="text-align: justify">
         ...
         </span></p>', 'Anthony William', 0, '/img/co-the-tu-chua-lanh-giai-cuu-gan.jpg', 'Tiếng Việt', 'Cơ Thể Tự Chữa Lành: Giải Cứu Gan', 166000, '2022-07-30', 'NXB Thanh Niên', 100, 5 ),
       ('<p style="text-align: justify">
    <span style="font-size: 14px">
 ...
 <p style="text-align: justify">
   ...
   Với những trang sách này, chúng ta mới cảm nhận được những nét phác thảo chặng đường cầm quân của Tổng tư lệnh Võ Nguyên Giáp trong suốt cuộc trường chinh đánh thắng hai đế quốc lớn.</span></p>', 'Trần Trọng Trung', 0, '/img/vo-nguyen-giap-danh-tuong-thoi-dai-hcm.jpg', 'Tiếng Việt', 'Võ Nguyên Giáp Danh Tướng Thời Đại Hồ Chí Minh', 257000, '2022-06-25', 'NXB Chính Trị Quốc Gia Sự Thật', 100, 6 ),
       ('<p style="text-align: justify">
    <span style="font-size: 14px">
 ...
 <p style="text-align: justify"><span style="font-size: 14px">
   ...
   giúp bạn đọc hiểu rõ hơn nguyên tác. Cuốn sách còn có phần phụ như giải thích, dịch nghĩa bằng câu từ tinh tế giúp bạn đọc thưởng thức trọn vẹn nội dung tác phẩm.</span></p>', 'Tư Mã Thiên', 0, '/img/su-ky-tu-ma-thien.jpg', 'Tiếng Việt', 'Sử Ký Tư Mã Thiên (Bìa Cứng)', 228000, '2022-07-20', 'NXB Văn học', 100, 7 ),
       ('<p style="text-align: justify">
    <span style="font-size: 14px">
...
', 'Đinh Quang Hải', 0, '/img/quan-he-bien-gioi-tren-dat-lien-giua-trung-quoc-va-cac-quoc-gia-lang-gieng.jpg', 'Tiếng Việt', 'Quan Hệ Biên Giới Trên Đất Liền Giữa Trung Quốc Với Các Quốc Gia Láng Giềng', 259000, '2022-05-25', 'NXB Khoa Học - Xã Hội', 100, 8 ),
       ('<p style="text-align: justify">
    <span style="font-size: 14px">
 ...
 <p style="text-align: justify">
     ...
     </span></p>', 'Gary Goldschneider', 0, '/img/chiem-tinh-hoc-ung-dung.jpg', 'Tiếng Việt', 'Chiêm Tinh Học Ứng Dụng', 350000, '2022-07-16', 'NXB Thế Giới', 100, 9 ),
       ('<p style="text-align: justify">
    <span style="font-size: 14px">
