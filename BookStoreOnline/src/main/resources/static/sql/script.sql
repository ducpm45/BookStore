...
(
    ...
    constraint UK_pdl1xoid4tn7se9eu59k7ju0l
        unique (items_item_id),
    constraint FK8avm7aefnukrxqqmk4pcxhpw2
        foreign key (items_item_id) references tbl_order_items (item_id),
    constraint FKly63np6qffcn7gt74d239g6ll
        foreign key (order_order_id) references tbl_orders (order_id)
);
